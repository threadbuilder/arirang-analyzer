...
public class KoreanEnv {
  ...
  private void initDefaultProperties() {
    ...
    defaults.setProperty(FILE_SYLLABLE_FEATURE,"org/apache/lucene/analysis/ko/dic/syllable.dic");
    defaults.setProperty(FILE_DICTIONARY,"org/apache/lucene/analysis/ko/dic/dictionary.dic");
    defaults.setProperty(FILE_EXTENSION,"org/apache/lucene/analysis/ko/dic/extension.dic");    
    defaults.setProperty(FILE_JOSA,"org/apache/lucene/analysis/ko/dic/josa.dic");  
    defaults.setProperty(FILE_EOMI,"org/apache/lucene/analysis/ko/dic/eomi.dic");  
    defaults.setProperty(FILE_PREFIX,"org/apache/lucene/analysis/ko/dic/prefix.dic");    
